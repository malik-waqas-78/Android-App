...
public class Order_Photocopy {
    ...
    public Order_Photocopy(String no_of_pages, String no_of_copiess, String page_sides, String pickup_point, String pickup_time, String extra_details, String current_time_milies, String status, String time, String date, String orderno, String type) {
        this.no_of_pages = no_of_pages;
        this.no_of_copiess = no_of_copiess;
        this.page_sides = page_sides;
        this.pickup_point = pickup_point;
