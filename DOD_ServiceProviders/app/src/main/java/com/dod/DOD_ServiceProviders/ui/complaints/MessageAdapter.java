...
public class MessageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case 0:
                return new MyCusViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.msg_customer, parent, false));
            default:
                return new MyProViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.msg_provider, parent, false));
        }
    }
